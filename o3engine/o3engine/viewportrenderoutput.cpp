...
namespace o3engine
{
	...
	ViewportRenderOutput::ViewportRenderOutput(int width, int height, int left, int bottom)
	...
	void ViewportRenderOutput::onMouseMove(const MouseEvent & e)
	{
    ...
    */
	...
	void ViewportRenderOutput::onMouseButtonPressed(const MouseEvent & e)
	{
    /*
    ...
    */
	...
	void ViewportRenderOutput::onMouseButtonReleased(const MouseEvent & e)
	{
    /*
