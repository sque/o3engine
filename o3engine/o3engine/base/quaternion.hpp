...
namespace o3engine {
	...
	public:
		 ...
		 * rotation as the one defined by method Angle-Axis
		...
		inline friend Quaternion operator*(Real factor, const Quaternion& r) {
			return Quaternion(factor * r.w, factor * r.x, factor * r.y,
					factor * r.z);
		}
		...
		//! Rotate a vector
		/**
		 * This is a fast way to rotate a vector, by multiplying quaternion with
