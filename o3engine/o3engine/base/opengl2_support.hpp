...
namespace o3engine {
	...
	inline void glVertex(const Triangle3 & tri3) {
		glVertex(tri3.point_a);
		glVertex(tri3.point_b);
		glVertex(tri3.point_c);
	}
	//! @}
	...
	inline void glLight(GLenum light, GLenum pname, const Vector4 & r) {
		GLfloat tmp_vector[4] = { (GLfloat) r.x, (GLfloat) r.y, (GLfloat) r.z,
				(GLfloat) r.w };
	...
	inline void glLight(GLenum light, GLenum pname, const Color & col) {
		GLfloat tmp_vector[4] = { (GLfloat) col.red, (GLfloat) col.green,
				(GLfloat) col.blue, (GLfloat) col.alpha };
		::glLightfv(light, pname, tmp_vector);
	}

	inline void glLightModel(GLenum pname, const Color & col) {
		GLfloat tmp_color[4] = { (GLfloat) col.red, (GLfloat) col.green,
				(GLfloat) col.blue, (GLfloat) col.alpha };
	...
	inline void glColor4(const Color & c) {
		::glColor4f((GLfloat) c.red, (GLfloat) c.green, (GLfloat) c.blue,
				(GLfloat) c.alpha);
	}
	//! @}
	...
	inline void glClearColor(const Color &c) {
		::glClearColor((GLfloat) c.red, (GLfloat) c.green, (GLfloat) c.blue,
				(GLfloat) c.alpha);
	}

	inline void glClearAccum(const Color &c) {
		::glClearAccum((GLfloat) c.red, (GLfloat) c.green, (GLfloat) c.blue,
				(GLfloat) c.alpha);
	}
	//! @}
