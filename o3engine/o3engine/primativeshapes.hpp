...
namespace o3engine
{
	...
	//! Primative object Circle (also ellipsis)
	/**
	...
	//! Primative object Quad
	/**
	 * A Quad (polygon with 4 sides) with defined points.
	 * Quad has texture coordinates repsecting the order of points like this
	 *  +----+
	 *  |0  1|
	 *  |    |
	 *  |3  2|
	 ...
	 * parametrize OrthoQuad by setting its height and width.
	 */
