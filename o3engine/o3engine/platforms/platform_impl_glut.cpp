...
namespace o3engine {
	...
	public:
		...
		impl() :
				m_window_name("O3 Engine"), m_window_height(240), m_window_width(
						320), m_window_back_color(Color::BLACK), mp_window_listener(
						NULL) {
		}
		...
		static void glutFuncReshape(int new_width, int new_height) {
			...
			pimpl->mp_window_listener->onWindowResized(old_width, old_height,
